/* ============================================================
   news.js — News cards + full article content for detail pages
   Update `source` links with official URLs as stories change.
   ============================================================ */
...
export const NEWS = [
  {
    ...
    date: "May 13, 2026",
    tags: ["CBSE", "Result"],
    title: "CBSE Class XII 2026 Results Declared — 87.98% Pass Rate",
    excerpt:
    ...
    image: "linear-gradient(135deg,#1d3557,#457b9d)",
    body: [
      ...
      "Students can check their results on the official CBSE results portal using their roll number, school number and date of birth. Digital marksheets are available on DigiLocker.",
      "Candidates dissatisfied with their scores can apply for verification of marks and re-evaluation within the stipulated window announced by the board.",
    ],
  },
  {
    slug: "jee-advanced-2026-admit-card",
    date: "May 11, 2026",
    tags: ["JEE Advanced", "Admit Card"],
    title: "JEE Advanced 2026 Admit Card Released on jeeadv.ac.in",
    excerpt:
    ...
    image: "linear-gradient(135deg,#0d1b3e,#3b3b98)",
    body: [
      ...
      "The admit card carries crucial details including the examination centre, reporting time, roll number and the day's instructions. Candidates must carry a printed copy along with a valid photo ID.",
      "JEE Advanced 2026 is scheduled to be held in two compulsory papers on the announced exam day. Discrepancies in the admit card should be reported to the Chairman of the respective zonal IIT immediately.",
    ],
  },
  {
    slug: "iiith-ugee-2026-result",
    date: "May 11, 2026",
    tags: ["IIIT Hyderabad", "Result"],
    title: "IIITH UGEE 2026 Result Declared — Merit List Out",
    excerpt:
    ...
    image: "linear-gradient(135deg,#0b525b,#2ec4b6)",
    body: [
      ...
      "IIIT Hyderabad remains one of the most competitive computer-science destinations in India, with placements that rival the top IITs.",
    ],
  },
  {
    slug: "viteee-2026-result",
    date: "May 8, 2026",
    tags: ["VITEEE", "Result"],
    title: "VITEEE Result 2026 Declared — Score Cards Available",
    excerpt:
    ...
    image: "linear-gradient(135deg,#1b6b5e,#2ec4b6)",
    body: [
      ...
      "The counselling process for B.Tech admissions will begin from the last week of May. Candidates must register for counselling and exercise their campus and branch preferences within the deadline.",
    ],
  },
  {
    slug: "jee-main-2026-session2-paper2-result",
    date: "May 5, 2026",
    tags: ["JEE Main", "Result"],
    title: "JEE Main 2026 Session 2 Paper 2 Result Declared",
    excerpt:
    ...
    image: "linear-gradient(135deg,#e63946,#ff6b75)",
    body: [
      ...
      "The Paper 2 score is used for admission to architecture and planning programmes at NITs, SPAs and other participating institutes through JoSAA/CSAB counselling.",
    ],
  },
  {
    slug: "jee-advanced-2026-registration-extended",
    date: "May 5, 2026",
    tags: ["JEE Advanced", "Important Notice"],
    title: "JEE Advanced 2026 Registration Deadline Extended to May 9",
    excerpt:
      "The registration deadline for JEE Advanced 2026 has been extended. Late fee applicable from May 7–9, 2026.",
    source: "https://jeeadv.ac.in",
    image: "linear-gradient(135deg,#3b3b98,#6c5ce7)",
    body: [
      ...
      "Candidates are advised to complete their registration and fee payment well in advance to avoid last-minute portal congestion.",
    ],
  },
  {
    slug: "josaa-2026-schedule",
    date: "May 2, 2026",
    tags: ["JoSAA", "Counselling"],
    title: "JoSAA 2026 Counselling Schedule Announced — 6 Rounds",
    excerpt:
    ...
    body: [
      ...
      "Candidates who do not get a satisfactory allotment after JoSAA can participate in the CSAB Special Rounds for vacant NIT+ seats.",
    ],
  },
  {
    slug: "csab-2026-special-rounds",
    date: "Apr 28, 2026",
    tags: ["CSAB", "Counselling"],
    title: "CSAB 2026 Special Rounds to Fill Vacant NIT+ Seats",
    excerpt:
      "CSAB will conduct two special rounds after JoSAA to fill remaining seats in NITs, IIITs and GFTIs.",
    source: "https://csab.nic.in",
    image: "linear-gradient(135deg,#5a3e85,#7209b7)",
    body: [
      ...
      "Fresh registration and choice-filling is required for CSAB; candidates should track the official csab.nic.in portal for exact dates.",
    ],
  },
];
